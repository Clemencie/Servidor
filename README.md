...
| Arquivo | Função |
|---------|--------|
|  `rolador.py` | Rolador de dados 100% aleatório (módulo `secrets`, sem seed, sem manipulação). Uso: `python3 rolador.py pool 3` (modo BoTI) ou `python3 rolador.py 1d20+3` |
